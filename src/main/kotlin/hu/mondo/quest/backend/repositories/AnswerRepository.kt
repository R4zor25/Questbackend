...
interface AnswerRepository : JpaRepository<Answer, Long> {
    ...
    @Query("Select a from Answer where a.imageAnswerState = 1  Order by a.id desc limit 10") //TODO check ON THESE
    fun get10LatestApprovedAnswers(): List<ImageAnswer>
    // GET ALL ANSWERS BY ANSWER STATE
    @Query("Select a from Answer where a.imageAnswerState = :imageAnswerState")
    ...
    @Query("Select a from Answer where a.user.questUserId = :questUserId")
